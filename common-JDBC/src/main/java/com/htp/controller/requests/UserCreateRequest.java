...
public class UserCreateRequest {
    ...
    public UserCreateRequest(String firstName, String lastName, String passportId, String phoneNumber, String userName,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(firstName, lastName, passportId, phoneNumber, userName, userPassword, createdWhen, modifyWhen, isDeleted);
    }
