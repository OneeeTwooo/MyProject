...
public class Car {
    ...
    public Car(Long car_id, String gosNumber, String mark, String model, Date yearOut, String type, Float fullCost,
               Float costOneDay, Timestamp createdWhen, Timestamp modifyWhen) {
        this.car_id = car_id;
    ...
    public int hashCode() {
        ...
        return Objects.hash(car_id, gosNumber, mark, model, yearOut, type, fullCost, costOneDay, createdWhen, modifyWhen);
    }
