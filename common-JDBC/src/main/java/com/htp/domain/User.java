...
public class User {
    ...
    public User(Long userId, String firstName, String lastName, String passportId, String phoneNumber, String userName,
                String userPassword, Timestamp createdWhen, Timestamp modifyWhen, String isDeleted) {
        this.userId = userId;
    ...
    public int hashCode() {
        ...
        return Objects.hash(userId, firstName, lastName, passportId, phoneNumber, userName, userPassword, createdWhen, modifyWhen, isDeleted);
    }
